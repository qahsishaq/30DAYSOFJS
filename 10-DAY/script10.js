...
// A set emphasizes of uniqueness of elements.It ignores repeated elements.
const demonymArray = [
  "Nigerian",
  "Ghanaian",
  "Cape Verdian",
...
const setOfUniqueDemonyms = new Set(demonymArray);
console.log(setOfUniqueDemonyms);
console.log(typeof setOfUniqueDemonyms);

for (const setElement of setOfUniqueDemonyms) {
  console.log(setElement);
}
const objects = new Set();
console.log(objects.size);

objects.add("Samsung tablet");
objects.add("Hairbrush");
objects.add("Islamic pamphlet"); // to add an element to a set
objects.add("Headwarmer");
objects.add("Textbook");
console.log(objects.has("Textbook"));
console.log(objects.size);

objects.delete("Textbook"); // to delete an element from a set
console.log(objects.size);
console.log(objects.has("Textbook"));
//EXERCISES
//Level 1
...
const utensils = ["spoon", "fork", "knife", "spatula", "whisks"];
let setOfUtensils = new Set(utensils);
console.log(setOfUtensils);
...
let mapOfCountries = new Map(countries);
...
let X = new Set(x);
let S = new Set(s);
let sprime = x.filter((num) => !S.has(num));
let sPrime = new Set(sprime);
console.log(sPrime);
//Level 3
const nations = [
  {
...
const allLanguages = nations.flatMap((country) => country.languages);
console.log(allLanguages);

let setOfallLanguages = new Set(allLanguages);
console.log(setOfallLanguages); //There are 112 languages.

let crray = [{ boy: 2 }, { girl: 4 }];
console.log(crray);
const counts = [];
